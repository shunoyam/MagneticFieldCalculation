...
plt.subplots_adjust(left=.23, right=.9, bottom=.12, top=0.934,hspace=0)
plt.tight_layout()
...
ax2.set_ylabel('Ratio of pockets\n with full of iron [%]',fontsize=s)
ax2.set_ylim(-5,60)
ax2.yaxis.set_major_locator(MaxNLocator(5))
ax2.plot(tolerance,rate_max,c='#05af',markersize=s_marker,marker='o')
